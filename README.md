# 구글 스튜디오 & 구글 애널리틱스 연동 대쉬보드 개발 연습
 ...
 오늘은 구글 스튜디오를 이용하여 데이터 시각화를 연습해보는 시간을 갖도록 할게요. 시작하기 앞서, 준비된 데이터 파일 이름은 Data.csv이며, 이 파일은 아래와 같은 열을 포함하고 있습니다

## Google Anyltics 4(GA4) 대신 Google Studio를 사용하는 이유
